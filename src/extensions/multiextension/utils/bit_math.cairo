...
use clt_ekubo::extensions::multiextension::interfaces::multiextension::{Constants, Errors};
...
fn get_method_bit_shift(method: ExtensionMethod) -> u256 {
    match method {
        ExtensionMethod::BeforeInitPool => Constants::BEFORE_INIT_POOL_BIT_SHIFT,
        ExtensionMethod::AfterInitPool => Constants::AFTER_INIT_POOL_BIT_SHIFT,
        ExtensionMethod::BeforeSwap => Constants::BEFORE_SWAP_BIT_SHIFT,
        ExtensionMethod::AfterSwap => Constants::AFTER_SWAP_BIT_SHIFT,
        ExtensionMethod::BeforeUpdatePosition => Constants::BEFORE_UPDATE_POSITION_BIT_SHIFT,
        ExtensionMethod::AfterUpdatePosition => Constants::AFTER_UPDATE_POSITION_BIT_SHIFT,
        ExtensionMethod::BeforeCollectFees => Constants::BEFORE_COLLECT_FEES_BIT_SHIFT,
        ExtensionMethod::AfterCollectFees => Constants::AFTER_COLLECT_FEES_BIT_SHIFT,
    }
}
...
fn get_queue_bit_shift(method: ExtensionMethod) -> u32 {
    match method {
        ExtensionMethod::BeforeInitPool => Constants::BEFORE_INIT_POOL_QUEUE_BIT_SHIFT,
        ExtensionMethod::AfterInitPool => Constants::AFTER_INIT_POOL_QUEUE_BIT_SHIFT,
        ExtensionMethod::BeforeSwap => Constants::BEFORE_SWAP_QUEUE_BIT_SHIFT,
        ExtensionMethod::AfterSwap => Constants::AFTER_SWAP_QUEUE_BIT_SHIFT,
        ExtensionMethod::BeforeUpdatePosition => Constants::BEFORE_UPDATE_POSITION_QUEUE_BIT_SHIFT,
        ExtensionMethod::AfterUpdatePosition => Constants::AFTER_UPDATE_POSITION_QUEUE_BIT_SHIFT,
        ExtensionMethod::BeforeCollectFees => Constants::BEFORE_COLLECT_FEES_QUEUE_BIT_SHIFT,
        ExtensionMethod::AfterCollectFees => Constants::AFTER_COLLECT_FEES_QUEUE_BIT_SHIFT,
    }
}
...
pub fn activate_extension(
    ...
    assert(
        extension_id.into() < Constants::MAX_EXTENSIONS_COUNT,
...
pub fn set_queue_position(queue: u32, method: ExtensionMethod, position: u8) -> u32 {
    //extension id should be less tha MAX_EXTENSIONS_COUNT
    assert(
        position.into() < Constants::MAX_EXTENSIONS_COUNT, Errors::MAX_EXTENSIONS_COUNT_EXCEEDED,
    );
    //get shift for provided method
